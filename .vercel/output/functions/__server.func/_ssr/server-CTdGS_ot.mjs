...
import { n as createCsrfMiddleware } from "./server-CTdGS_ot2.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D7sKM0pR.mjs");
...
var manifest = {
	"26e0ad3ba15d26c3b3b635e9ae69050cad62771506c0759c530e586fe4f370ac": {
		...
		importer: () => import("./payment-methods.functions-k-BOu_kQ.mjs")
	},
	"3082e488c4a8779ced42ff7d7eb0cb04aaf3c1cba345399c512c9e4e1bae4239": {
		functionName: "verifyPayment_createServerFn_handler",
		importer: () => import("./payments.functions-BSB0Q77S.mjs")
	},
	"377adb88f76be82b3b842c83d63b452509e037a8f8502f9e653a9f6cb109bc15": {
		functionName: "quoteDelivery_createServerFn_handler",
		importer: () => import("./orders.functions-0WgMqpj4.mjs")
	},
	"3cbee22e85d2a0512250a9b1695d1c0b39c73579ab0fa99c92f8e0c3d5eefe2b": {
		functionName: "subscribeNewsletter_createServerFn_handler",
		importer: () => import("./leads.functions-CT2IRrLW.mjs")
	},
	"81ebdc76d7715e2ec6681729423a391a581eb56db9bb3dbc43f9403df008c1e2": {
		functionName: "checkCoupon_createServerFn_handler",
		importer: () => import("./coupons.functions-CqOxt_6n.mjs")
	},
	"a6485a0caa6c7276b8f38fd2e39c7cd965ae3addca5ff318987f97661206380a": {
		functionName: "placeOrder_createServerFn_handler",
		importer: () => import("./orders.functions-0WgMqpj4.mjs")
	},
	"aae52ddaafa71e2fd6fe4f654d6748821a7a052b23661038917bedf31f658b0c": {
	...
	"f00c53440c18c2248a544a63f718c4c41472e9639164cd0a54c4f180f003ff00": {
		functionName: "getBankDetails_createServerFn_handler",
		importer: () => import("./payment-methods.functions-k-BOu_kQ.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Bg0ak8An2.mjs").then((n) => n.t),
		import("./start-flo9kGzH.mjs"),
...
//#endregion
export { getServerFnById as a, __exportAll as c, getRequestHeader as i, createServerEntry as n, server_default as o, createServerFn as r, server_exports as s, TSS_SERVER_FUNCTION as t };
